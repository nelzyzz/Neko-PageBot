...
module.exports = {
  name,
  description: "Interact with Neko",
  async run ({ api, event, send, args }) {
    const uid = event.sender.id;
    const prompt = args.join(" ");

    const missingPromptResponses = [
      "Hi, I am Neko! How can I assist you today?",
      "Hello! What do you need help with?",
      "Hey there! Ask me anything, I’m ready to assist.",
      "I'm here to help! Please ask your question or provide a prompt.",
      "Neko at your service! Feel free to type your question or prompt."
    ];

    // Improved system prompt for better responses
    const system = `
      You are an AI assistant named Neko. 
      You should always introduce yourself as Neko, a helpful assistant.
